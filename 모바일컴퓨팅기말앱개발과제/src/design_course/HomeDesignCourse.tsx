...
const CATEGORIES = ['Clothes', 'Shoes', 'Acc'];
...
const HomeDesignCourse: React.FC = () => {
  ...
  const renderScrollableHeader = (
    <>
      ...
      <Text style={styles.sectionHeaderText}>HOT Item</Text>
      ...
      />
      <Text style={styles.sectionHeaderText}>2023 New Collection Item</Text>
    </>
  );

  return (
    <View style={{ flex: 1, backgroundColor: 'black', paddingTop }}>
      <StatusBar backgroundColor="black" barStyle="dark-content" />
      <View style={styles.header}>
        <View style={{ flex: 1, justifyContent: 'center' }}>
          <Text style={styles.headerTextNormal}>Choose your</Text>
          <Text style={styles.headerTextBold}>PIU SHOP</Text>
        </View>
        <Image
